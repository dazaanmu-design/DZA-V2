...
6. Klik **Run workflow**.
7. Setelah selesai, buka hasil workflow lalu download artifact **DZA-debug-apk**.
8. File APK ada di dalam artifact dengan nama `DZA.apk`.
...
```xml
<string name="app_name">DZA</string>
```
